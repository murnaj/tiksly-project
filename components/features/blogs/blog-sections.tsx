...
import { getAuthorForPost, posts } from "./blog-data";
    ...
    <section className="bg-linear-to-b from-white via-white to-[#F3F5F9]">
      <div className="container mx-auto px-3 lg:px-4 py-16 md:py-20 text-center">
        ...
        >
          ...
          >
            Latest playbooks, benchmarks, and best practices for creator-led
            growth.
          </motion.p>
        </motion.div>
      </div>
...
/* ── Section 2: Filters + Recently Published grid ────────────────────── */
        ...
        <div className="flex items-end justify-between gap-4 mb-8 md:mb-10">
          <div>
            ...
            <p className="text-gray-500 text-[15px]">
              Our latest and greatest step-by-step guides on creator
              marketing, paid social, and attribution.
            </p>
          </div>
          <Link
            href="#"
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredPosts.map((post) => (
              ...
              >
                <PostCard post={post} author={getAuthorForPost(post)} />
              </motion.div>
            ))}
          </AnimatePresence>
        </motion.div>
