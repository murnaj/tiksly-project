        ...
        <div className="container mx-auto px-3 lg:px-4 py-16 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr] items-center gap-10">
            <div>
              <span
                className={cn(
                  "inline-block mb-4 px-3 py-1 rounded-full text-[12px] font-medium uppercase tracking-wide",
                  theme.badge,
                )}
              >
                {post.category}
              ...
              <h1
                className={cn(
                  "text-3xl md:text-4xl lg:text-[44px] font-black tracking-tight leading-[1.1] mb-6",
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <p className={cn(isDark ? "text-gray-400" : "text-black/50")}>
            ...
            <div className="hidden md:flex justify-center">
              <div
                className={cn(
                  "flex h-40 w-full max-w-72 items-center justify-center rounded-[2rem]",
                  isDark ? "bg-white/5 border border-white/10" : "bg-white/70",
                )}
              >
                <Icon
                  className={cn("w-16 h-16", theme.icon)}
                  strokeWidth={1.25}
                />
              </div>
            </div>
