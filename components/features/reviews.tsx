...
const Reviews = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-white via-[#F6FED9] to-white pt-14 md:pt-20 mt-5 md:mt-10 overflow-hidden w-full relative pb-16">
      ...
      <div className="container mx-auto mb-6 text-center">
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-black mb-4 leading-tight">Don't take our word for it. </h2>
      ...
      <div className="relative w-full overflow-hidden reviews-marquee-container select-none">
        {/* Edge fades */}
        <div className="absolute left-0 top-0 bottom-0 w-16 md:w-28 bg-gradient-to-r from-[#F6FED9] to-transparent z-30 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-16 md:w-28 bg-gradient-to-l from-[#F6FED9] to-transparent z-30 pointer-events-none" />
