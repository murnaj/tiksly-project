      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 text-zinc-600 text-lg leading-relaxed">
            <p>
              It all started when we noticed something big TikTok Shop was
              blowing up, but so many brands had no idea how to tap into its
              full potential. We knew this wasn&apos;t just another trend; it
              was the future of eCommerce. So, we built Tiksly.
            </p>
            <p>
              Now, with a team of 20+ experts, we help brands not just sell on
              TikTok Shop but thrive. We handle everything optimizing product
              listings, creating scroll-stopping videos, running high performing
              campaigns so our clients can focus on growing their business while
              we drive the sales.
            </p>
            <p>
              What makes us different? We don&apos;t do cookie-cutter
              strategies. We test, tweak, and scale what actually works.
              We&apos;re not just another agency we&apos;re partners in growth,
              obsessed with helping brands win in this fast-moving space.
            </p>
            <p>And honestly? We&apos;re just getting started.</p>
          </div>
        </div>
