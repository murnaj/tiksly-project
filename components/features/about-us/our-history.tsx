...
const historyData = [
  {
    ...
    description:
      "After years of dedication, we officially launched Reearm, our first agency specializing in SEO, eBay, Amazon, and OnBuy. A team of passionate young minds came together, turning expertise into a full-scale service.",
  ...
  },
  {
    ...
    description:
      "We identified TikTok Shop as the next big player in eCommerce. Seeing its potential to rival major marketplaces, we pivoted our focus, preparing for an expansion into this fast-growing space.",
  ...
  },
  {
    ...
    description:
      "Driven by vision and experience, we launched Tiksly, assembling a powerhouse team of 20+ professionals dedicated to scaling brands and managing high-performing TikTok Shop accounts globally.",
  ...
  },
  {
    ...
    description:
      "We expanded our reach to international markets, managing over 50+ major brands and establishing Tiksly as a premier official partner for TikTok Shop scaling and operations.",
  ...
  },
  {
    ...
    title: "Today & Beyond",
    description:
      "Tiksly continues to push boundaries, driving success for brands worldwide. And this is just the beginning—our journey of growth, innovation, and excellence is far from over.",
