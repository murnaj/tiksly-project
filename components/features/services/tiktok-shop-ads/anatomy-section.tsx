...
export default function AnatomySection() {
  ...
  const features = [
    ...
    },
    {
      ...
      positionClass: "-left-4 bottom-10",
    },
  ];
    ...
    <section className="bg-gradient-to-b from-white via-[#F6FED9] to-white w-full pt-14 md:pt-18 pb-14 md:pb-18 overflow-hidden">
      <div className="container mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          >
            ...
            <p className="text-[#6B7280] text-[15px] md:text-[16px] leading-relaxed max-w-3xl mx-auto">
              Great ads aren&apos;t luck. Every winner we run has these four
              things dialed in.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            {/* Phone Container with EXPLICIT width and height */}
            <div className="relative w-[270px] sm:w-[290px] md:w-[310px] h-[540px] sm:h-[580px] md:h-[620px] shrink-0">
              {/* Phone Outer Shell */}
