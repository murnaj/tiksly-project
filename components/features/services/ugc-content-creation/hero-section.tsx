            ...
            >
              <div className="relative w-full max-w-[280px] min-[400px]:max-w-[320px] sm:max-w-[500px] h-full mx-auto">
                ...
                <motion.div
                  ...
                  className="absolute right-0 bottom-0 sm:bottom-10 w-[155px] min-[400px]:w-[175px] sm:w-[220px] md:w-[260px] h-[220px] min-[400px]:h-[250px] sm:h-auto sm:aspect-[9/16] rounded-[1.5rem] sm:rounded-[2.5rem] overflow-hidden shadow-2xl border-[4px] sm:border-[6px] border-white/80 bg-black z-20"
                >
                  <ChatAnimation />
                </motion.div>
              </div>
