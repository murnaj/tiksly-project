      ...
      <div className="container mx-auto py-24 md:py-32 max-w-4xl">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
            Welcome to Tiksly. Your privacy is important to us, and we are
        ...
        <div className="flex flex-col gap-10">
          ...
          <section className="border-b border-gray-100 pb-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <li className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                ...
                <p className="text-gray-500 text-xs leading-relaxed">
                  Browser type, IP address, and cookies to enhance user
                  experience.
                </p>
              </li>
              <li className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
          ...
          <section className="border-b border-gray-100 pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100">
                ...
                <p className="text-gray-500 text-xs leading-relaxed">
                  Third-party partners assisting in payment processing,
              ...
              <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100">
                ...
                <p className="text-gray-500 text-xs leading-relaxed">
                  If required by law, to comply with legal processes or protect
                  our rights.
                </p>
              </div>
              <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100">
          ...
          <section className="border-b border-gray-100 pb-8">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              Tiksly uses cookies and tracking tools to enhance your experience.
              You can manage or disable cookies through your browser settings,
              though some website functionalities may be affected.
            </p>
          </section>
          ...
          <section className="border-b border-gray-100 pb-8">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              ...
              responsible for their privacy policies or practices. Please review
